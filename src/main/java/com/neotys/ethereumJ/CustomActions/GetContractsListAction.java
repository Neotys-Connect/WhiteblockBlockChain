...
public class GetContractsListAction implements Action {
    private static final String BUNDLE_NAME = "com.neotys.ethereumJ.GetContractsList.bundle";
    ...
    public List<ActionParameter> getDefaultActionParameters() {
        ...
        for (final GetContractsListOption option : GetContractsListOption.values()) {
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return GetContractsListActionEngine.class;
    }
    ...
    public String getDescription() {
        return "Get the list of account available in the network .\n\n" + Arguments.getArgumentDescriptions(GetContractsListOption.values());
    }
