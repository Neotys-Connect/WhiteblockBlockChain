...
enum SafeTransfertERC721TokenOption implements Option

{
    ...
    to("to", Required, True, TEXT,
            ...
            "Address of the account that will receive the transaction",
            NON_EMPTY),
    tokenid("tokenid", Required, True, TEXT,
    ...
    SafeTransfertERC721TokenOption(final String name, final Option.OptionalRequired optionalRequired,
