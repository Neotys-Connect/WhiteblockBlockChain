...
public class MinerAction implements Action {
    private static final String BUNDLE_NAME = "com.neotys.ethereumJ.MinerStart.bundle";
    ...
    public List<ActionParameter> getDefaultActionParameters() {
        ...
        for (final MinerStartOption option : MinerStartOption.values()) {
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return MinerActionEngine.class;
    }
    ...
    public String getDescription() {
        return "Enable/Disable the mining .\n\n" + Arguments.getArgumentDescriptions(MinerStartOption.values());
