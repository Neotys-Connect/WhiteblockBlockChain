...
public class SendSignedTransactionActionEngine implements ActionEngine {
    ...
    public SampleResult execute(Context context, List<ActionParameter> parameters) {
        ...
        final String nodeIP = parsedArgs.get(SendSignedTransactionOption.NodeIP.getName()).get();
        final String nodePort = parsedArgs.get(SendSignedTransactionOption.NodePort.getName()).get();
