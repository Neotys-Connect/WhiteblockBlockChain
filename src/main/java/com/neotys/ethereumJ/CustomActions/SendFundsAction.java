...
public class SendFundsAction  implements Action {
    private static final String BUNDLE_NAME = "com.neotys.ethereumJ.SendFunds.bundle";
    ...
    public List<ActionParameter> getDefaultActionParameters() {
        ...
        for (final SendFundsOption option : SendFundsOption.values()) {
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return SendFundsActionEngine.class;
    }
    ...
    public String getDescription() {
        return "Send SendFunds to another account .\n\n" + Arguments.getArgumentDescriptions(SendFundsOption.values());
