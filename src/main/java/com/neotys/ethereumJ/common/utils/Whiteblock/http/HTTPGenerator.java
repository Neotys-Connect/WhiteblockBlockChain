...
import static com.neotys.ethereumJ.common.utils.Whiteblock.http.HTTPGeneratorUtils.*;
...
public class HTTPGenerator {
	...
	public JSONArray executeAndGetJsonArrayResponse() throws IOException, WhiteBlockHttpException, JSONException {
		...
		if (!HttpResponseUtils.isSuccessHttpCode(httpResponse.getStatusLine().getStatusCode())) {
			...
			throw new WhiteBlockHttpException(httpResponse.getStatusLine().getReasonPhrase() + " - "+ request + " - " + stringResponse);
		}
